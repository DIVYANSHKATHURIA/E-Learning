...
function DashboardTeacher() {
  ...
  return (
    <>
      {/* Navbar */}
      <nav className='bg-[#04253A] px-4 sm:px-6 lg:px-10 py-3 flex justify-between items-center sticky top-0 z-50 shadow-lg'>
        <NavLink to="/" className="flex items-center gap-2 sm:gap-3 hover:opacity-80 transition-opacity">
          ...
          <h1 className='text-lg sm:text-xl lg:text-2xl text-[#4E84C1] font-bold'>E-Learning</h1>
        </NavLink>
        ...
        <div className="flex items-center gap-4">
          ...
          <button 
            ...
            className="lg:hidden bg-[#0D199D] text-white p-2 rounded-lg hover:bg-[#0D199D]/80 transition-colors"
          >
          ...
          <button 
            ...
            className='bg-[#0D199D] hover:bg-[#0D199D]/80 text-white py-2 px-4 sm:px-5 rounded-full transition-all duration-200 flex items-center gap-2 text-sm sm:text-base'
          >
      ...
      {/* Welcome Section */}
      <div className='bg-gradient-to-r from-[#008280] to-[#00a09e] flex flex-col lg:flex-row justify-between items-center px-4 sm:px-6 lg:px-20 py-8 lg:py-12'>
        <div className='text-center lg:text-left mb-6 lg:mb-0'>
          <h1 className='text-2xl sm:text-3xl lg:text-5xl font-bold text-[#071645] mb-4 lg:mb-5 leading-tight'>
            Welcome to <span className='text-white'>E-Learning</span>
          </h1>
          <h3 className='text-xl sm:text-2xl lg:text-3xl text-[#071645] font-semibold'>
        ...
        <div className='flex-shrink-0'>
          <img 
            src={teachingImg} 
            alt="teaching" 
            className="w-48 sm:w-64 lg:w-80 xl:w-96 h-auto"
          />
        </div>
      </div>
      ...
      <div className="flex min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
        ...
        {/* Sidebar */}
        <div className={`bg-[#071645] w-64 lg:w-72 fixed lg:sticky top-0 h-screen z-50 flex flex-col transition-transform duration-300 ease-in-out ${
          ...
          <div className='flex flex-col gap-4 items-center text-white mt-4 lg:mt-6 mb-8 px-4'>
            <div className="w-16 h-16 lg:w-20 lg:h-20 rounded-full overflow-hidden border-2 border-white/20 shadow-lg">
              <img 
            ...
            <p className="text-sm lg:text-base font-medium text-center leading-tight">
              {data.Firstname} {data.Lastname}
            </p>
          </div>
            ...
            <NavLink 
              ...
              className={({isActive}) => 
                `flex items-center gap-3 p-3 lg:p-4 rounded-lg font-semibold transition-all duration-200 ${
                  isActive 
                    ? "bg-white text-[#071645] shadow-md" 
          ...
          <div className="mt-8 px-4 space-y-3">
            <h4 className="text-white/70 text-sm font-medium uppercase tracking-wide">Quick Actions</h4>
            <button
              onClick={() => {
                setPopup(true);
                setSidebarOpen(false);
              }}
              className="w-full flex items-center gap-3 p-3 text-white hover:bg-white/10 rounded-lg transition-all duration-200 text-left"
            >
              <TbCurrencyRupee className="text-xl text-green-400" />
            ...
            <button
              ...
              className="w-full flex items-center gap-3 p-3 text-white hover:bg-white/10 rounded-lg transition-all duration-200 text-left"
            >
              <TbMessage2Star className="text-xl text-purple-400" />
              ...
              <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 items-start lg:items-center justify-between">
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full lg:w-auto">
                  ...
                  <button
                    ...
                    className="bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white px-6 sm:px-8 py-3 rounded-lg font-semibold transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5 text-sm sm:text-base"
                  >
                ...
                <div className="bg-gradient-to-r from-emerald-500 to-teal-600 text-white px-4 sm:px-6 py-3 rounded-lg shadow-md w-full lg:w-auto">
                  ...
                  <div className="text-center mb-6">
                    ...
                    <div className="flex justify-center items-center gap-1">
                      {[...Array(starCount)].map((_, index) => (
                        <FiStar key={index} className="text-yellow-400 fill-current" size={18} />
                      ))}
                    </div>
                  </div>
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 sm:p-8">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="w-10 h-10 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg flex items-center justify-center">
                      <TbBook className="text-white text-xl" />
                    </div>
                    <h3 className="text-xl sm:text-2xl font-bold text-gray-800">Active Courses</h3>
                  </div>
                  ...
                  {courses && courses.length > 0 ? (
                    <div className="space-y-6">
                      {courses
                        ...
                        .map((course) => (
                          <div key={course._id} className="border border-gray-200 rounded-xl p-4 sm:p-6 hover:shadow-md transition-all duration-200 hover:border-blue-300">
                            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-4">
                              ...
                              <div className="flex items-center gap-2 bg-green-400 text-white px-3 sm:px-4 py-2 rounded-lg shadow-sm flex-shrink-0">
                                <TbCurrencyRupee className="text-lg" />
                    ...
                    <div className="text-center py-12">
                      <TbBook className="text-6xl text-gray-300 mx-auto mb-4" />
        ...
        {formPopup && (
          <div className='fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center p-4 z-50'>
            <div className='bg-white w-full max-w-4xl max-h-[90vh] overflow-y-auto rounded-xl shadow-2xl transform transition-all duration-300'>
              {/* Modal Header */}
              <div className="sticky top-0 bg-white border-b border-gray-200 px-4 sm:px-8 py-4 sm:py-6 rounded-t-xl">
                <div className="flex justify-between items-start">
                  <div className="flex-1 pr-4">
                    <h2 className='text-2xl sm:text-3xl font-bold text-gray-800 mb-2'>Teacher Feedback Form</h2>
                  ...
                  <button 
                    ...
                    className="w-10 h-10 bg-gray-100 hover:bg-gray-200 rounded-full flex items-center justify-center transition-colors duration-200 flex-shrink-0"
                  >
              ...
              <div className="px-4 sm:px-8 py-4 sm:py-6">
                <div className='space-y-4 sm:space-y-6 pb-6 border-b border-gray-200'>
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-2">Full Name</label>
                    <input 
                      type="text" 
                      className='w-full p-3 sm:p-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-gray-800 text-sm sm:text-base'  
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-2">Number of Years Teaching?</label>
                    <input 
                      type="text" 
                      className='w-full p-3 sm:p-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-gray-800 text-sm sm:text-base'  
                ...
                <div className='py-4 sm:py-6 flex flex-col items-center'>
                  <p className='text-base sm:text-lg font-medium text-gray-700 text-center mb-4'>
                    Do you have suggestions on what we can do to provide you with a better service?
                  </p>
                  <textarea 
                    className="w-full h-32 p-3 sm:p-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 resize-none text-gray-800 text-sm sm:text-base" 
