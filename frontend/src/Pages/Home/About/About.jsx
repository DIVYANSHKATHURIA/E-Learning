          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-3xl shadow-2xl p-10 md:p-14 lg:p-20 mb-20 relative overflow-hidden mx-4 md:mx-8 lg:mx-12">
            ...
            <div className="relative z-10 space-y-8 text-center md:text-left mb-12">
              ...
              <p className="text-xl md:text-2xl text-blue-100 leading-relaxed">
                At <strong className="text-white">DTU E‑Learning</strong>, we believe in the power of education to transform lives and unlock human potential through innovative digital learning experiences.
              </p>
            </div>
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
              <div className="space-y-6">
                ...
                <p className="text-blue-50 leading-relaxed text-lg">
                  DTU E‑Learning was born out of a passion for learning and a desire to make quality education accessible to everyone. We recognized the transformative power of technology in education and set out to create a platform that bridges the gap between traditional learning and modern digital experiences.
                </p>
              </div>
              <div className="space-y-6">
                <h3 className="inline-flex items-center bg-white text-blue-600 px-6 py-3 rounded-full font-semibold text-lg shadow-lg">
